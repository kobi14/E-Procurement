                        ...
                        <div class="col-md-4">
                          ...
                          <div class="input-group">
        									...
        									<div class="input-group">
        										...
        										<input type="text" class="form-control"name="username" style="font-size:20px;"  placeholder="User Name..." value="<?php echo $u_username; ?>" />
                          ...
                          <div class="input-group">
							...
							<span><font color='red'><?php echo $errcontact; ?></font></span>
        									...
        									<div class="input-group label-floating has-error">
        										...
        										<input type="email"  class="form-control  validate" name="email" style="font-size:20px;" placeholder="Email..." value="<?php echo $email; ?>" />
        									...
        									<div class="input-group">
        										...
        										<input type="password"  class="form-control" name="password1" style="font-size:20px;" placeholder="Password..." value="" />
                          ...
                          <div class="input-group">
        										...
        										<input type="password"  class="form-control" name="password2" style="font-size:20px;" placeholder="Confirm Password..." value="" />
