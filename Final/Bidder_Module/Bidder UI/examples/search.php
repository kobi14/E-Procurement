	        ...
	        <div class="content">
	            <div class="container-fluid">
	                        ...
	                        <div class="card">
	                            ...
	                            <div class="card-content table-responsive">
	                                <table class="table">
                                      ...
                                      <?php  include('C:\xampp\htdocs\e-procurement\UI\connect.php');
                                      $sql="SELECT * FROM tender ORDER BY TenderID ASC ";
                                      $result=mysql_query($sql,$conn);
                                      ?><th>Tender ID</th>
                                      <th>Tender File</th>
                                      <th>Tender Owner</th>
                    <th>Openeing Date and Time</th>
                    ...
                    <th>Category<th>
					  ...
					  <!--<td class="text-primary">--><td><?php echo "$row[3]" ;?></td>
