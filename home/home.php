    	...
    	<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
         <i  class="brand-logo"><p id="demo"></p></i>
    		<ul class="nav navbar-nav right hide-on-med-and-down">
        		...
        		<li><a href="../Final/Bidder_Module/signup.php">Sign Up</a></li>
        		<li><a href="../Final/Bidder_Module/login.php">Sign In</a></li>
          </ul>
        		<!--<li class="dropdown">
...
<?php
      ...
      $activeMembers=$row['num'];
			...
			$sql2="SELECT COUNT(*) AS num FROM tender WHERE ODate=CURDATE()";//curdate() eken system date eka enawa.
			$data2 = mysqli_query($conn, $sql2);//excute the query
			$row2=mysqli_fetch_assoc($data2);//
			$openToday=$row2['num'];

			//closiing today tender count
			$sql3="SELECT COUNT(*) AS num FROM tender WHERE CDate=CURDATE()";//curdate() eken system date eka enawa.
     ...
     ?>
      ...
      <div class="container-fluid">
        <div class="row">
            ...
            <div class=" #82b1ff blue accent-1" style="padding: 20px 10px; width: 200px; box-shadow: 5px 5px grey" align="center"><h4 style="font-family:serif;"><?php echo $activeMembers;?></h4></div>
            <div class=" #546e7a blue-grey darken-1 " align="center" style="padding: 5px 10px; width: 200px; box-shadow: 5px 5px grey"><span style="font-family:serif; color:white; font-size: 15pt" >Active members</span></div>
            <div class=" #82b1ff blue accent-1  " style="padding: 20px 10px; width: 200px; box-shadow: 5px 5px grey " align="center"><h4 style="font-family:serif;"><?php echo $openToday;?></h4></div>
            <div class=" #546e7a blue-grey darken-1  " align="center" style="padding: 5px 20px; width: 200px; box-shadow: 5px 5px grey"><span style="font-family:serif; color:white; font-size: 15pt" >Tenders Opening Today</span></div>
            <div class="  #82b1ff blue accent-1  " style="padding: 20px 20px; width: 200px; box-shadow: 5px 5px grey " align="center"><h4 style="font-family:serif;"><?php echo $closeToday;?></h4></div>
            <div class=" #546e7a blue-grey darken-1 " align="center" style="padding: 5px 20px; width: 200px; box-shadow: 5px 5px grey"><span style="font-family:serif; color:white; font-size: 15pt" >Tenders closing Today</span></div>
...
<!-- end side bar -->
    ...
    <div class="col-md-8"><!-- start the tables -->
     <div class="row"><!-- start 1st table row -->
      ...
      <h3 class="#546e7a blue-grey darken-1 col-md-4" style=" box-shadow: 5px 5px grey; font-family:Impact;  font-size: 20pt">Latest Tenders</h3>
      <table class="table table-hover">
      <thead class="#546e7a blue-grey darken-1" style=" box-shadow: 5px 5px grey" >
        <tr>
          <th>Tender Title</th>
          <th>Reference</th>
          <th>Closing Date</th>
    ...
    <div class="row"><!-- start 2nd table row -->
      ...
      <h3 class="#546e7a blue-grey darken-1 col-md-4" style=" box-shadow: 5px 5px grey; font-family:Impact;  font-size: 20pt ">Latest Corrigendums</h3>
      <table class="table table-hover">
      <thead class="#546e7a blue-grey darken-1" style=" box-shadow: 5px 5px grey">
        <tr>
          <th>Tender Title</th>
    ...
    <!-- start calender -->
    <div class="col-md-2">
    <div class="row #546e7a blue-grey darken-1" style=" box-shadow: 5px 5px grey;" >
      <form action="search.php" method="POST"><!--serch.php akata form ake data gnnawa post aken-->
        <input id="input"     name="search" type="text" placeholder="Search tenders by title..." required>
        <div align="center">
