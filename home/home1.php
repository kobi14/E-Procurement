  ...
  <div class="container-fluid">
      ...
      <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
        ...
        <li class="active"><a href="home.php">Home</a></li>
            ...
            <li><a href="../Final/Bidder_Module/login.php">Sign Ip</a></li>
          </ul>
            <!--<li class="dropdown">
...
<!-- end side bar -->
    ...
    <div class="col-md-8"><!-- start the tables -->
     <div class="row"><!-- start 1st table row -->
      ...
      <h3 class="#546e7a blue-grey darken-1 col-md-4" style=" box-shadow: 5px 5px grey; font-family:Impact;  font-size: 20pt">Tenders by title</h3>
